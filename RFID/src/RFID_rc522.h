 ...
 * Mo ta chuc nang:  Dau doc the chong va cham  chon giao dien dau doc the
 */
...
#define PICC_READ             0x30               // doc
#define PICC_WRITE            0xA0               // viet
#define PICC_DECREMENT        0xC0               //Ghi 
#define PICC_INCREMENT        0xC1               //Nap 
#define PICC_RESTORE          0xC2               //Chuyen  du lieu vao bo dem
